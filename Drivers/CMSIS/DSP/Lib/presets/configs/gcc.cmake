...
# For gcc 10q4
SET(CMAKE_C_FLAGS "-DARM_MATH_HELIUM -DARM_MATH_LOOPUNROLL -DARMv81MML_DSP_DP_MVE_FP -flax-vector-conversions -ffunction-sections -fdata-sections -march=armv8.1-m.main+mve.fp+fp.dp" CACHE INTERNAL "C compiler common flags")
SET(CMAKE_CXX_FLAGS "-DARM_MATH_HELIUM -DARM_MATH_LOOPUNROLL -DARMv81MML_DSP_DP_MVE_FP -flax-vector-conversions -ffunction-sections -fdata-sections -march=armv8.1-m.main+mve.fp+fp.dp" CACHE INTERNAL "C compiler common flags")
SET(CMAKE_ASM_FLAGS "-DARM_MATH_HELIUM -DARM_MATH_LOOPUNROLL -DARMv81MML_DSP_DP_MVE_FP -march=armv8.1-m.main+mve.fp+fp.dp" CACHE INTERNAL "ASM compiler common flags")
...
SET(CMAKE_C_FLAGS "-flax-vector-conversions -ffunction-sections -fdata-sections -march=armv8.1-m.main+dsp+fp.dp" CACHE INTERNAL "C compiler common flags")
SET(CMAKE_CXX_FLAGS "-flax-vector-conversions -ffunction-sections -fdata-sections -march=armv8.1-m.main+dsp+fp.dp" CACHE INTERNAL "C compiler common flags")
...
SET(CMAKE_C_FLAGS "-flax-vector-conversions -ffunction-sections -fdata-sections -mcpu=${ARM_CPU}" CACHE INTERNAL "C compiler common flags")
SET(CMAKE_CXX_FLAGS "-flax-vector-conversions -ffunction-sections -fdata-sections -mcpu=${ARM_CPU}" CACHE INTERNAL "C compiler common flags")
