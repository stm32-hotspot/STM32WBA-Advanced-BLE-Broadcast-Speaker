/**
  ******************************************************************************
  * @file    BLE_Spkeaer_WBA5_bsp_audio.c
  * @author  MCD Application Team
  * @brief   This file provides the Audio driver for the speaker board, derivated
  *          from stm32wba55g_discovery_audio.c.
  ******************************************************************************
  * @attention
  *
  ...
  ******************************************************************************
  ...
  ==============================================================================
   + This driver supports STM32WBAxx devices on STM32WBA55XXX board.
   ...
   + For each mode, you may need to implement the relative callback functions into your code.
      ...
      the board_bsp_audio.h file. (refer to the example for more details on the callbacks implementations)
   ...
   + The driver API and the callback functions are at the end of the board_bsp_audio.h file.
...
/* Includes ------------------------------------------------------------------*/
#include "BLE_Speaker_WBA5_bsp_audio.h"

/** @addtogroup BSP
  * @{
  */

/** @addtogroup STM32WBA55XXX
  * @{
  */

/** @defgroup STM32WBA55XXX_AUDIO AUDIO
  * @{
  */

/** @defgroup STM32WBA55XXX_AUDIO_Private_Macros AUDIO Private Macros
  * @{
  */
...
/** @defgroup STM32WBA55XXX_AUDIO_Exported_Variables AUDIO Exported Variables
  * @{
  */
...
/** @defgroup STM32WBA55XXX_AUDIO_Private_Variables AUDIO Private Variables
  * @{
  */
...
/** @defgroup STM32WBA55XXX_AUDIO_Private_Function_Prototypes AUDIO Private Function Prototypes
  * @{
  */
...
/** @addtogroup STM32WBA55XXX_AUDIO_OUT_Exported_Functions
  * @{
  */
/**
...
/**
  ...
  * @retval BSP status.
  */
extern void Component_SetVolume(uint8_t vol);
...
void HAL_SAI_TxCpltCallback(SAI_HandleTypeDef *hsai)
{
  ...
  /* Manage the remaining file size and new address offset: This function
     should be coded by user (its prototype is already declared in board_bsp_audio.h) */
...
/** @defgroup STM32WBA55XXX_AUDIO_OUT_Private_Functions AUDIO OUT Private Functions
  * @{
  */
#if (USE_HAL_SAI_REGISTER_CALLBACKS == 1)
/**
...
/** @addtogroup STM32WBA55XXX_AUDIO_IN_Exported_Functions
  * @{
  */
...
/** @defgroup STM32WBA55XXX_AUDIO_IN_Private_Functions AUDIO IN Private Functions
  * @{
  */
...
/** @defgroup STM32WBA55XXX_AUDIO_Private_Functions AUDIO Private Functions
  * @{
  */
