...
static void metadatamydsp(MetaGlue *m)
{
  ...
  m->declare(m->metaInterface, "filename", "faust_flanger.dsp");
  ...
  m->declare(m->metaInterface, "name", "faust_flanger");
...
static void buildUserInterfacemydsp(mydsp *dsp, UIGlue *ui_interface)
{
  ...
  ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Depth", &dsp->fHslider0, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.001f);
  ...
  ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Feedback", &dsp->fHslider3, (FAUSTFLOAT)0.0f, (FAUSTFLOAT) - 0.999f, (FAUSTFLOAT)0.999f, (FAUSTFLOAT)0.001f);
  ui_interface->closeBox(ui_interface->uiInterface);
  ...
  ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Delay Offset", &dsp->fHslider5, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)2e+01f, (FAUSTFLOAT)0.001f);
  ui_interface->closeBox(ui_interface->uiInterface);
  ui_interface->declare(ui_interface->uiInterface, 0, "3", "");
  ui_interface->openHorizontalBox(ui_interface->uiInterface, "0x00");
  ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider2, "unit", "dB");
  ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Flanger Output Level", &dsp->fHslider2, (FAUSTFLOAT)0.0f, (FAUSTFLOAT) - 6e+01f, (FAUSTFLOAT)1e+01f, (FAUSTFLOAT)0.1f);
  ui_interface->closeBox(ui_interface->uiInterface);
  ui_interface->closeBox(ui_interface->uiInterface);
}
#endif
...
static void computemydsp(mydsp *dsp, int count, FAUSTFLOAT **RESTRICT inputs, FAUSTFLOAT **RESTRICT outputs)
{
  ...
  float fSlow6 = powf(1e+01f, 0.05f * (float)(dsp->fHslider2));
  float fSlow7 = (float)(dsp->fHslider3);
  float fSlow8 = 0.0005f * (float)(dsp->fHslider4);
  float fSlow9 = 0.001f * (float)(dsp->fHslider5);
  /* C99 loop */
  {
    int i0;
    ...
    {
      dsp->iVec0[0] = 1;
      dsp->fRec1[0] = fSlow5 * dsp->fRec2[1] + fSlow4 * dsp->fRec1[1];
      dsp->fRec2[0] = (float)(1 - dsp->iVec0[1]) + fSlow4 * dsp->fRec2[1] - fSlow5 * dsp->fRec1[1];
      dsp->fHbargraph0 = (FAUSTFLOAT)(dsp->fRec2[0] + dsp->fRec1[0]);
      float fTemp0 = (float)(input0[i0]);
      float fTemp1 = fSlow6 * ((iSlow0) ? 0.0f : fTemp0);
      float fTemp2 = fSlow7 * dsp->fRec0[1] - fTemp1;
      dsp->fVec1[dsp->IOTA0 & 4095] = fTemp2;
      float fTemp3 = dsp->fConst0 * (fSlow9 + fSlow8 * (dsp->fRec1[0] + 1.0f));
      int iTemp4 = (int)(fTemp3);
      float fTemp5 = floorf(fTemp3);
      dsp->fRec0[0] = dsp->fVec1[(dsp->IOTA0 - min(2049, max(0, iTemp4))) & 4095] * (fTemp5 + (1.0f - fTemp3)) + (fTemp3 - fTemp5) * dsp->fVec1[(dsp->IOTA0 - min(2049, max(0, iTemp4 + 1))) & 4095];
      output0[i0] = (FAUSTFLOAT)(((iSlow0) ? fTemp0 : 0.5f * (fTemp1 + dsp->fRec0[0] * fSlow2)));
      float fTemp6 = (float)(input1[i0]);
      float fTemp7 = fSlow6 * ((iSlow0) ? 0.0f : fTemp6);
      float fTemp8 = fSlow7 * dsp->fRec3[1] - fTemp7;
      dsp->fVec2[dsp->IOTA0 & 4095] = fTemp8;
      float fTemp9 = dsp->fConst0 * (fSlow9 + fSlow8 * (dsp->fRec2[0] + 1.0f));
      ...
      output1[i0] = (FAUSTFLOAT)(((iSlow0) ? fTemp6 : 0.5f * (fTemp7 + dsp->fRec3[0] * fSlow2)));
