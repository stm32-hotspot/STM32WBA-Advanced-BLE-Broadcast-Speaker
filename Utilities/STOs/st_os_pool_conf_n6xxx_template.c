/**
  ******************************************************************************
  * @file        st_os_pool_conf_n6xxx_template.c
...
#ifndef ST_OS_POOL_AXI_ENABLE
  #define ST_OS_POOL_AXI_ENABLE 0UL
#endif

#ifndef ST_OS_POOL_NPU_ENABLE
  #define ST_OS_POOL_NPU_ENABLE 0UL
#endif
...
void st_os_mem_init(void)
{
  ...
  /* Create pools in order of speed */
  ...
  st_os_mem_create_pool(ST_Mem_Type_POOL3, POOL_AXI_BASE,   POOL_AXI_SIZE,    "RAMINT1", ST_OS_POOL_AXI_ENABLE);
  st_os_mem_create_pool(ST_Mem_Type_POOL4, POOL_NPU_BASE,   POOL_NPU_SIZE,    "RAMINT2", ST_OS_POOL_NPU_ENABLE);
  st_os_mem_create_pool(ST_Mem_Type_POOL5, RAMEXT_BASE,     RAMEXT_SIZE,      "RAMEXT",  ST_OS_POOL_RAMEXT_ENABLE);
  st_os_mem_create_pool(ST_Mem_Type_POOL6, CODE_BASE,       CODE_SIZE,        "CODE",    PMEM_FLAG_DISABLED);
  st_os_mem_create_pool(ST_Mem_Type_POOL7, SECTION_DMA_OFF, SECTION_DMA_SIZE, "DMA",     PMEM_FLAG_DISABLED);
  st_os_mem_create_pool(ST_Mem_Type_HEAP,  0UL,             0UL,              "HEAP",    PMEM_FLAG_DISABLED);
