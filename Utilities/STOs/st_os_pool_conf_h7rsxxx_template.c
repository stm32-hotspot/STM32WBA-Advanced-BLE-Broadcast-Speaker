...
void st_os_mem_init(void)
{
  ...
  /* Create pools */
  st_os_mem_create_pool(ST_Mem_Type_POOL1, POOL_DTCM_BASE,   POOL_DTCM_SIZE,   "DTCM",   0UL);
  st_os_mem_create_pool(ST_Mem_Type_POOL2, POOL_ITCM_BASE,   POOL_ITCM_SIZE,   "ITCM",   0UL);
  st_os_mem_create_pool(ST_Mem_Type_POOL3, POOL_RAMINT_BASE, POOL_RAMINT_SIZE, "RAMINT", 0UL);
  st_os_mem_create_pool(ST_Mem_Type_POOL4, POOL_RAMEXT_BASE, POOL_RAMEXT_SIZE, "RAMEXT", 0UL);
