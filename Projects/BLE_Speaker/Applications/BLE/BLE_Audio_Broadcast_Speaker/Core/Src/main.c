...
static void MX_TIM1_Init(void)
{
  ...
  htim1.Init.Period = 7; // default value, updated later
  ...
  sConfigOC.Pulse = 3; // default value, updated later
...
{
  if(GPIO_Pin == SPEAKER_FUELG_IT_PIN)
  {
    Sys_Notify_Evt(FUEL_GAUGE_IT);
  }
  if(GPIO_Pin == SPEAKER_CHG_IT_PIN)
  {
    Sys_Notify_Evt(STOP_CHRG);
  }
  if(GPIO_Pin == SPEAKER_BP3_PIN)
  {
    Button_rising_evnt(BUTTON_3);
  }
  if(GPIO_Pin == SPEAKER_BP2_PIN)
  {
    Button_rising_evnt(BUTTON_2);
  }
  if(GPIO_Pin == SPEAKER_BP1_PIN)
  {
    Button_rising_evnt(BUTTON_1);
  }
  if(GPIO_Pin == SPEAKER_BP_POWER_PIN)
  {
    Button_rising_evnt(BUTTON_PWR);
  }
}
...
void HAL_GPIO_EXTI_Falling_Callback(uint16_t GPIO_Pin)
{
  if(GPIO_Pin == SPEAKER_CHG_IT_PIN)
  {
    Sys_Notify_Evt(START_CHRG);
  }
  if(GPIO_Pin == SPEAKER_BP3_PIN)
  {
    Button_falling_evnt(BUTTON_3);
  }
  if(GPIO_Pin == SPEAKER_BP2_PIN)
  {
    Button_falling_evnt(BUTTON_2);
  }
  if(GPIO_Pin == SPEAKER_BP1_PIN)
  {
    Button_falling_evnt(BUTTON_1);
  }
  if(GPIO_Pin == SPEAKER_BP_POWER_PIN)
  {
    Button_falling_evnt(BUTTON_PWR);
  }
}
