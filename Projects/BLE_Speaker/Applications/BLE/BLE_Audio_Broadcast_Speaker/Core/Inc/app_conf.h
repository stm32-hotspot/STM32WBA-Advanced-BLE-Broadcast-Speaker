...
#define EW25DEMO                  (1)  /* boot in scan mode, remove 5V off mode for avoidoing pops */

#define BAT_MNGMT                 (0)  /* use fuel gauge SOC for system states */

#define USB_LIVETUNE              (1)  /* Set vdd to 3.3V, requiered for USB communication, 2.2V otherwise */

#define RELEASE                   (0)  /* auto reset generation and enable auto switch off */

#if (EW25DEMO == 0)
/* alternate demo starts in advertising mode, demonstrate low power feature */
#undef BAT_MNGMT
#define BAT_MNGMT                 (1)

#undef USB_LIVETUNE
#define USB_LIVETUNE              (0)
