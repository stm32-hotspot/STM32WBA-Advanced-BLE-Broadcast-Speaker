...
#endif
/* warning in H5 the mode snap doesn't work bezcause not enough memory */

#define TRC_CFG_STREAM_PORT_BUFFER_SIZE  ((6 * 1024 * 1024) - 5000)
#define TRC_CFG_RECORDER_DATA_ATTRIBUTE __attribute__((section(".tr_Section")))
#ifndef TRC_CFG_START_TYPE
#define TRC_CFG_START_TYPE                TRC_START_FROM_HOST
#endif
 ...
 */
#ifndef TRC_CFG_CTRL_TASK_PRIORITY
 ...
 */
#define TRC_CFG_CTRL_TASK_DELAY 3
 ...
 */
#ifndef TRC_CFG_RECORDER_BUFFER_ALLOCATION
 ...
 */
#ifndef TRC_CFG_RECORDER_DATA_ATTRIBUTE
